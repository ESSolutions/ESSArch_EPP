...
urlpatterns = [
    ...
    url(r'^delivery_list_dt/?$', Delivery_dt_view.as_view(), name='delivery_list_dt'),
    url(r'^delivery_number_list_dt/?$', Delivery_number_dt_view.as_view(), name='delivery_number_list_dt'),
    url(r'^event_list_dt/?$', Event_dt_view.as_view(), name='event_list_dt'),
    url(r'^event_type_list_dt/?$', Event_type_dt_view.as_view(), name='event_type_list_dt'),
