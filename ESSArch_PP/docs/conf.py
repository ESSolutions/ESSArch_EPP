...
# -*- coding: utf-8 -*-
#
# ESSArch Preservation Platform documentation build configuration file, created by
...
html_context = {
    ...
    'github_repo': 'essarch_epp',
    'github_version': 'master/ESSArch_PP/docs/'
}
...
project = u'ESSArch Preservation Platform'
...
htmlhelp_basename = 'ESSArchPreservationPlatformdoc'
...
latex_documents = [
    (master_doc, 'ESSArchPreservationPlatform.tex', u'ESSArch Preservation Platform Documentation',
...
man_pages = [
    (master_doc, 'essarchpreservationplatform', u'ESSArch Preservation Platform Documentation',
     [author], 1)
]
