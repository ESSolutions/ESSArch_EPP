...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Path.value'
        db.alter_column(u'configuration_path', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Path.entity'
        db.alter_column(u'configuration_path', 'entity', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'ESSConfig.Value'
        db.alter_column('ESSConfig', 'Value', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'ESSConfig.Name'
        db.alter_column('ESSConfig', 'Name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'ESSProc.Name'
        db.alter_column('ESSProc', 'Name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'ESSProc.LogFile'
        db.alter_column('ESSProc', 'LogFile', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'ESSProc.Path'
        db.alter_column('ESSProc', 'Path', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'SchemaProfile.value'
        db.alter_column(u'configuration_schemaprofile', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'SchemaProfile.entity'
        db.alter_column(u'configuration_schemaprofile', 'entity', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Parameter.value'
        db.alter_column(u'configuration_parameter', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Parameter.entity'
        db.alter_column(u'configuration_parameter', 'entity', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Path.value'
        db.alter_column(u'configuration_path', 'value', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Path.entity'
        db.alter_column(u'configuration_path', 'entity', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))

        # Changing field 'ESSConfig.Value'
        db.alter_column('ESSConfig', 'Value', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'ESSConfig.Name'
        db.alter_column('ESSConfig', 'Name', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'ESSProc.Name'
        db.alter_column('ESSProc', 'Name', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'ESSProc.LogFile'
        db.alter_column('ESSProc', 'LogFile', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'ESSProc.Path'
        db.alter_column('ESSProc', 'Path', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'SchemaProfile.value'
        db.alter_column(u'configuration_schemaprofile', 'value', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'SchemaProfile.entity'
        db.alter_column(u'configuration_schemaprofile', 'entity', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))

        # Changing field 'Parameter.value'
        db.alter_column(u'configuration_parameter', 'value', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Parameter.entity'
        db.alter_column(u'configuration_parameter', 'entity', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))
    ...
    models = {
        ...
        u'configuration.essproc': {
            'LogFile': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
