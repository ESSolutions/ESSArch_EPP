    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ObjectActive', models.IntegerField(null=True, choices=[(1, b'Active'), (2, b'Inactive')])),
                ...
                ('Status', models.IntegerField(null=True, choices=[(1, b'DjVu references loaded'), (2, b'ADDML metadata loaded'), (3, b'Not Approved'), (4, b'During work'), (5, b'Available in HSM')])),
