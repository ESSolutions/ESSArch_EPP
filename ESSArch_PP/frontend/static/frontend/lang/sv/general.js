angular.module('essarch.language').config(function($translateProvider) {
    $translateProvider.translations('sv', {
        ...
        "DIR_EXISTS_IN_DIP_DESC": "Det existerar redan en mapp med detta namn i utlämnandet. Vill du skriva över den nuvarande mappen?",
        ...
        "FILE_EXISTS_IN_DIP_DESC": "Det existerar redan en fil med detta namn i utlämnandet. Vill du skriva över den nuvarande filen?",
