angular.module('essarch.controllers').controller('AccessModalInstanceCtrl', function ($uibModalInstance, data, $scope, Requests, $q) {
    ...
    $ctrl.access = function() {
        $ctrl.accessing = true;
        var data = { purpose: $ctrl.data.request.purpose, tar: $ctrl.data.request.type === "get_tar", extracted: $ctrl.data.request.type === "get", new: $ctrl.data.request.type === "get_as_new", package_xml: $ctrl.data.request.package_xml, aic_xml: $ctrl.data.request.aic_xml};
        var promises = [];
