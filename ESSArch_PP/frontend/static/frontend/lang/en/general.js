angular.module('essarch.language').config(function($translateProvider) {
    $translateProvider.translations('en', {
        ...
        "DIR_EXISTS_IN_DIP_DESC": "Folder with this name already exists in the dissemination. Do you want to overwrite current folder?",
        ...
        "FILE_EXISTS_IN_DIP_DESC": "File with this name already exists in the dissemination. Do you want to overwrite current file?",
